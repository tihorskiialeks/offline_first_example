...
@injectable
class ChangeUserUsecase implements UseCase<Either<Failure, void>, UserEntity> {
  final UserRepository _userRepository;

  ChangeUserUsecase(this._userRepository);

  @override
  Future<Either<Failure, void>> call(UserEntity user) async {
    return await _userRepository.changeUser(user);
  }
}
